...
import './Hero.css';
import unoImg from '../hero-images/uno.webp';
import hotwheelsImg from '../hero-images/hotwheels.webp';
import familyImg from '../hero-images/family.webp';
        ...
        <div className="fwh-content">
          ...
          <div className="fwh-ctas">
            ...
            <a href="#hotwheels" className="fwh-cta-btn fwh-cta-secondary">
              <span className="fwh-btn-text">HotWheels Collectors Edition</span>
            </a>
          </div>
